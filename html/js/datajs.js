...
function addDom(dateY,dateM) {
    // console.log(dateY+"("+typeof dateY+")"+dateM+"("+typeof dateM+")");
    ...
    **********************/
    ...
    $(".l_infoPop").parent().on("click",function() {
      ...
      var YY = $(this).attr('data_y'),
          MM = $(this).attr('data_m'),
          DD = $(this).attr('data_d');
        // console.log(YY+"("+typeof YY+")"+MM+"("+typeof MM+")"+DD+"("+typeof DD+")")
        ...
        if (inx == "Daylist") {
          for (var i = 0; i < obj.length; i++) {
            var li = $("<li>").addClass(hasBackOrNot(obj[i].hasBackOrNot)).appendTo($(".l_infoList")),
                ...
                p2 = $("<p>").html("<span id='benOrLi'>"+obj[i].backMoney+"</span><span>待回金额</span>").appendTo(li),
    ...
    // 遍历json并插入相应dom元素，以及元素的点击事件----end
}
